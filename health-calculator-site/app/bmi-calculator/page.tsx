...
const bmiFaqs = [
  ...
  },
  {
    ...
    a: "Don't panic â€” BMI is a screening tool, not a diagnosis. If you're physically active, eat well, and have normal blood sugar, cholesterol, and blood pressure, a slightly elevated BMI may not be medically significant. Measure your waist circumference and see a doctor for metabolic blood tests to get a complete picture.",
  },
  {
    q: 'Can I be healthy at BMI 25 or above?',
    a: "For Indians, BMI 25+ is in the obese range and does carry increased health risk on a population level. However, individual health outcomes depend on many factors â€” fitness level, metabolic health markers, lifestyle habits, and family history. See a doctor for personalised advice.",
  },
  {
...
export default function BMICalculatorPage() {
  ...
  function calcBMI() {
    ...
    if (+bmi < 18.5) {
      cat = 'Underweight'; color = '#bbdefb'; sub = 'Below 18.5 â€” consider gaining weight healthily';
    } else if (+bmi < 23) {
      cat = 'Normal Weight âœ“'; color = '#c8e6c9'; sub = 'Healthy range for Indians (18.5â€“22.9)';
    } else if (+bmi < 25) {
      cat = 'Overweight'; color = '#ffe0b2'; sub = 'Above healthy range for Asians (23.0â€“24.9)';
    } else if (+bmi < 30) {
      cat = 'Obese (Class I)'; color = '#ffcdd2'; sub = 'Significantly above healthy range';
    } else {
      cat = 'Obese (Class II+)'; color = '#ef9a9a'; sub = 'High health risk â€” medical consultation advised';
    }
    ...
    <>
      ...
      <div className="bmi-hero">
        <div className="breadcrumb">
          <Link href="/calculator">Home</Link> â€º BMI Calculator
        </div>
        <span className="hero-emoji">âš–ï¸</span>
        <h1>BMI Calculator <span>for Indians</span></h1>
        <p>
          Get your BMI using Asian-specific healthy weight ranges â€” because standard
      ...
      <section className="bmi-calc-section">
        <div className="bmi-calc-card">
          ...
          <button className="calc-btn" onClick={calcBMI}>Calculate BMI â†’</button>
      ...
      <div className="content-wrap">
        <div className="bmi-section">
          ...
          <p>
            ...
            â€” not an individual diagnostic measure.
          </p>
          ...
          <p>
            For example, a person who is 170 cm (1.70 m) tall and weighs 70 kg has a BMI of 70 Ã· (1.70 Ã— 1.70) = <strong>24.2</strong>.
          </p>
        </div>
        ...
        <div className="bmi-section">
          ...
          <table className="bmi-table">
            ...
            <tbody>
              ...
              <tr><td>18.5 â€“ 22.9</td><td className="norm">Normal weight</td><td className="norm">Normal weight</td></tr>
              <tr><td>23.0 â€“ 24.9</td><td className="norm">Normal weight</td><td className="ow">Overweight</td></tr>
              <tr><td>25.0 â€“ 29.9</td><td className="ow">Overweight</td><td className="ob">Obese (Class I)</td></tr>
              <tr><td>30.0 and above</td><td className="ob">Obese</td><td className="ob">Obese (Class II+)</td></tr>
            </tbody>
          </table>
          <div className="highlight-box">
            <strong>Key takeaway:</strong> If you&apos;re Indian and your BMI is 23â€“24.9, Western charts say you&apos;re
        ...
        <div className="bmi-section">
          ...
          <p>
            ...
            appear lean or have a &ldquo;normal&rdquo; Western BMI but carry a high percentage of body fat â€” particularly
          ...
          <p>
            ...
            is around 22â€“23, compared to 25 in European populations.
          </p>
        ...
        <div className="bmi-section">
          <h2>Limitations of BMI â€” What BMI Doesn&apos;t Tell You</h2>
        ...
        <div className="bmi-section">
          ...
          <table className="bmi-table">
            ...
            <tbody>
              ...
              <tr><td>Waist Circumference (elevated risk)</td><td>85â€“90 cm</td><td>80â€“85 cm</td></tr>
        ...
        <div className="teal-cta-bar">
          ...
          <Link href="/ideal-weight-calculator">Try Ideal Weight Calculator â†’</Link>
        </div>
