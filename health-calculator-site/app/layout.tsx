...
export const metadata: Metadata = {
  title: "CalorieIndia – Indian Food Calorie Tracker",
  description:
    "Track calories, calculate BMI, macros and more with Indian food data.",
};
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <head>
        {/* GTM – replace GTM-XXXXXXX with your real container ID */}
        <script
